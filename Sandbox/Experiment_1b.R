...
beta_design = benchmark_grid(tasks, learners, resamplings,
                              paired = TRUE)
...
submitJobs(ids = 1:30, resources = resources, reg = reg)
